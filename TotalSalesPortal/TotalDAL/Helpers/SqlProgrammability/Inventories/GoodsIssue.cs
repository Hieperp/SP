...
namespace TotalDAL.Helpers.SqlProgrammability.Inventories
{
    ...
    public class GoodsIssue
    {
        ...
        private void GetGoodsIssueViewDetails()
        {
            ...
            queryNew = "                SELECT          DeliveryAdviceDetails.DeliveryAdviceID, DeliveryAdviceDetails.EntryDate AS DeliveryAdviceDate, 0 AS GoodsIssueDetailID, 0 AS GoodsIssueID, DeliveryAdviceDetails.DeliveryAdviceDetailID, NULL AS GoodsIssueTypeID, CAST(NULL AS nvarchar(50)) AS GoodsIssueTypeCode, CAST(NULL AS nvarchar(50)) AS GoodsIssueTypeName, NULL AS GoodsIssueClassID, " + "\r\n";
            ...
            queryEdit = "               SELECT          DeliveryAdviceDetails.DeliveryAdviceID, DeliveryAdviceDetails.EntryDate AS DeliveryAdviceDate, GoodsIssueDetails.GoodsIssueDetailID, GoodsIssueDetails.GoodsIssueID, DeliveryAdviceDetails.DeliveryAdviceDetailID, GoodsIssueTypes.GoodsIssueTypeID, GoodsIssueTypes.Code AS GoodsIssueTypeCode, GoodsIssueTypes.Name AS GoodsIssueTypeName, GoodsIssueTypes.GoodsIssueClassID, " + "\r\n";
            ...
            queryEdit = queryEdit + "                   GoodsIssueTypes ON GoodsIssueDetails.GoodsIssueTypeID = GoodsIssueTypes.GoodsIssueTypeID LEFT JOIN" + "\r\n";
