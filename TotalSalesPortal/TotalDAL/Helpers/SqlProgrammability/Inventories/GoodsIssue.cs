...
namespace TotalDAL.Helpers.SqlProgrammability.Inventories
{
    ...
    public class GoodsIssue
    {
        ...
        private void GetGoodsIssueIndexes()
        {
            ...
            queryString = queryString + "       SELECT      GoodsIssues.GoodsIssueID, CAST(GoodsIssues.EntryDate AS DATE) AS EntryDate, GoodsIssues.Reference, Locations.Code AS LocationCode, Customers.Name AS CustomerName, CASE WHEN GoodsIssues.CustomerID = GoodsIssues.ReceiverID THEN '' ELSE Receivers.Name + ', ' END + GoodsIssues.ShippingAddress AS ReceiverDescription, GoodsIssues.DeliveryAdviceReferences, GoodsIssues.TotalQuantity, GoodsIssues.TotalFreeQuantity, GoodsIssues.TotalListedGrossAmount, GoodsIssues.TotalGrossAmount, GoodsIssues.Description " + "\r\n";
