...
namespace TotalDAL.Helpers.SqlProgrammability.Reports
{
    public class SaleReports
    {
        ...
        private void DeliveryAdviceJournal()
        {
            ...
            queryString = queryString + "                   DeliveryAdviceDetails.Quantity, DeliveryAdviceDetails.FreeQuantity, DeliveryAdviceDetails.GrossAmount, " + "\r\n";
            queryString = queryString + "                   GoodsIssueDetails.EntryDate AS GoodsIssueEntryDate, GoodsIssueDetails.Quantity AS GoodsIssueQuantity, GoodsIssueDetails.FreeQuantity AS GoodsIssueFreeQuantity, " + "\r\n";
            ...
            queryString = queryString + "                   INNER JOIN DeliveryAdviceDetails ON (DeliveryAdvices.DeliveryAdviceID = @DeliveryAdviceID OR (@DeliveryAdviceID = 0 AND DeliveryAdvices.EntryDate >= @FromDate AND DeliveryAdvices.EntryDate <= @ToDate)) AND DeliveryAdvices.DeliveryAdviceID = DeliveryAdviceDetails.DeliveryAdviceID " + "\r\n";
